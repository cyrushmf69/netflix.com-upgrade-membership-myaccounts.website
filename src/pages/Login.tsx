          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1">
              <Input
                ...
                required
                className="h-12 bg-gray-700/50 border border-gray-600 text-white placeholder:text-gray-400 text-base rounded-md"
              />
            </div>
            <div className="space-y-1">
              <Input
            ...
            <Button 
              type="submit" 
              className="w-full h-12 bg-netflix-red hover:bg-netflix-red/90 text-white font-semibold text-base mt-6"
            >
              {isLogin ? 'Sign In' : 'Sign Up'}
            </Button>
